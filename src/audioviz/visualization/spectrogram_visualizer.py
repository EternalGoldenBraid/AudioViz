...
class SpectrogramVisualizer(VisualizerBase):
    ...
    def init_ui_old(self) -> None:
        ...
        self.spectrogram_plot_item.getViewBox().setLimits(
            yMin=self.spectrogram_y_range[0], yMax=self.spectrogram_y_range[1])
    ...
    def init_ui(self) -> None:
        ...
        self.spectrogram_plot_item.setLabel('left', "Frequency bins")
